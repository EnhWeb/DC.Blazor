...
namespace DC.Bue.Charts
{
    static class JS
    {
        ...
        {
            return runtime.InvokeAsync<bool>( "DC.BueCharts.setChartData", id, ToChartTypeString( type ), data, options, data is string, options is string );
        }
